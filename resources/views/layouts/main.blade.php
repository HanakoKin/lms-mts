...
<head>
    ...
    <link href="{{ asset('css/dycalendar.css') }}" rel="stylesheet">
...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">{{ Str::ucfirst( Auth::user()->name
                            )}}</span>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#courses-nav" href="/courses">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#calendar-nav" href="#">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#chat-nav" href="/chat">
